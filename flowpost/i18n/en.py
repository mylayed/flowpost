...
TEXTS: dict[str, str] = {
    ...
    "sch.pick": "Choose the publication time:",
    "sch.no_slots": "No free slots left for this day — choose another day.",
    "sch.this_post": "this post",
    "sch.more_slots": "↓ More slots",
    "sch.manual": "⌨️ Enter hours and minutes",
    "sch.manual_prompt": "Send the publication time for {date} as <b>Hours:Minutes</b>, e.g. <code>14:35</code>.",
    ...
    "set.sub_paid": "💎 Subscription active until {date} ({provider})",
    "set.sub_cancelled": "💎 Subscription valid until {date} ({provider}), auto-renewal off",
