...
TEXTS: dict[str, str] = {
    ...
    "fld.settings_title": "⚙️ <b>Folder «{title}» settings</b>",
    "fld.rename": "✏️ Rename",
    "fld.rename_prompt": "Send a new name for the folder «{title}».",
    "fld.renamed": "✅ Folder renamed to «{title}»",
    "fld.delete": "🗑 Delete folder",
